...
""", unsafe_allow_html=True)
    ...
    st.markdown("<div style='font-size:0.65rem;color:#6c757d;margin-top:0.2rem'>For inquiry, contact us at<br>arief.yusuf@dewanekonomi.go.id</div>", unsafe_allow_html=True)
...
with _nat_col:
    st.markdown("""<div style='padding-top:0.45rem;font-size:1rem;font-weight:700;color:#1a3358;text-align:right'>
...
<div style='margin-top:0.6rem;font-size:0.8rem;line-height:1.5'>
  ...
  PBI: Decile 1–{pbi_decile} &middot; PIP: Decile 1–{pip_decile} + school-age &nbsp;·&nbsp; <strong><span style='color:#1a3358'>Change target settings in the sidebar.</span></strong></span>
</div>
""", unsafe_allow_html=True)
...
<span style="font-size:0.9rem">The National Economic Council (<em>Dewan Ekonomi Nasional</em> — DEN) is <a href="https://dewanekonomi.go.id/profil/struktur-organisasi" target="_blank" style="color:#c8a84b">mandated</a> to monitor and evaluate the Indonesian government's strategic programs, including social protection programs. This dashboard is part of that monitoring effort, tracking
